...
mkdir build;
cd build;
cmake .. -DGLM_INCLUDE_DIR=/home/travis/build/JPEGtheDev/glm/ -DSDL2_INCLUDE_DIR=/home/travis/build/JPEGtheDev/SDL2_Build -DSDL2_LIBRARY=/home/travis/build/JPEGtheDev/SDL2_Build;
make;
